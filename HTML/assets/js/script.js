...
function loadStudents() {
    ...
    xhr.open("GET", `https://localhost:44305/api/aluno/Recuperar`, true);
...
function saveStudents(method, id, body) {
    ...
    xhr.open(method, `https://localhost:44305/api/Aluno/Recuperar/${id}`, false);
...
function addLine(student) {
    let trow = `<tr>
                    ...
                    <td>${student.ra}</td>
                    <td>
                        <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#myModal" onclick='editStudent(${JSON.stringify(
                            student
                        )})'>Editar</button>
